...
<div class="row mb-4 align-items-center">
    ...
    <div class="col-md-6 text-md-end">
        <button type="button" class="btn btn-custom btn-custom-primary" onclick="openRankModal();">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-custom btn-custom-secondary py-1 px-2" 
                                        onclick='openRankModal(<?= json_encode($rk) ?>);'>
...
<div class="modal fade" id="rankModal" tabindex="-1" aria-labelledby="rankModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content glass-card bg-dark text-light border-secondary">
            ...
            <form action="<?= BASE_URL ?>/ranks/save" method="POST">
                <?= Security::csrfField() ?>
                ...
                <div class="modal-footer border-secondary">
                    ...
                    <button type="submit" class="btn btn-custom btn-custom-primary">Save Rank</button>
                </div>
            </form>
        </div>
    </div>

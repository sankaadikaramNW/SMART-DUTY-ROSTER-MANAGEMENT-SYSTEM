...
<div class="row mb-4 align-items-center">
    ...
    <div class="col-md-6 text-md-end">
        <a href="<?= BASE_URL ?>/rosters/calendar" class="btn btn-custom btn-custom-secondary me-2">
            <i class="fas fa-calendar-check"></i> Monthly Calendar View
        </a>
        <a href="<?= BASE_URL ?>/rosters/timeline" class="btn btn-custom btn-custom-secondary me-2">
            <i class="fas fa-timeline"></i> Timeline Rotation View
        </a>
        <?php if ($roleName === 'SNCO' || $roleName === 'Administrator'): ?>
            <a href="<?= BASE_URL ?>/rosters/create" class="btn btn-custom btn-custom-primary">
                <i class="fas fa-calendar-plus"></i> Create Duty Roster
            </a>
        <?php endif; ?>
    </div>
</div>

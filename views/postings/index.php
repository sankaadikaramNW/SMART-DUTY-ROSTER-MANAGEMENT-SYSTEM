            ...
            <table class="table-custom" id="postingsTable">
                ...
                <tbody>
                    <?php if (empty($postings)): ?>
                        <tr>
                            <td colspan="7" class="text-center text-secondary py-4">No posting records registered.</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($postings as $p): ?>
                            <tr class="posting-row">
                                ...
                                <td class="font-monospace small"><?= $p['end_date'] ? date('Y-m-d', strtotime($p['end_date'])) : 'Active' ?></td>
                                <td>

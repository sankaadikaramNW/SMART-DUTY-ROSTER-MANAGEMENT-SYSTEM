...
$routes = [
    'GET' => [
        ...
        '/personnel/archived' => 'PersonnelController@archivedIndex',
        ...
        '/rosters/crew-history' => 'RosterController@crewHistory',
        ...
        '/users/archived' => 'AdminController@archivedUsersIndex',
        '/users/locked' => 'AdminController@lockedUsersIndex',
        ...
        '/change-password' => 'AuthController@changePasswordView',
        '/help' => 'AuthController@helpView',
    ],
    'POST' => [
        ...
        '/personnel/archive' => 'PersonnelController@archive',
        '/personnel/restore' => 'PersonnelController@restore',
        ...
        '/rosters/bulk-approve' => 'RosterController@bulkApprove',
        '/rosters/bulk-reject' => 'RosterController@bulkReject',
        '/rosters/audit-print' => 'RosterController@auditPrint',
        ...
        '/users/archive' => 'AdminController@archiveUser',
        '/users/restore' => 'AdminController@restoreUser',
        '/users/password-reset' => 'AdminController@resetPassword',
        '/users/unlock' => 'AdminController@unlockUser',
        ...
        '/change-password/save' => 'AuthController@changePasswordProcess',
    ]
];
